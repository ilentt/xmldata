...
To query all top product fruit in `datafile.xml` in this case you need select `fruitGroupID`, `name` from node fruits.
```xml
"$FRUITS"
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NDkzNzgwMTgsMTcwOTMwMTY3MCw1ND
